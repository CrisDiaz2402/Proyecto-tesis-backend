# app/core/prompts.py
"""
Prompts centralizados del sistema RAG.
Única fuente de verdad para todos los templates de LLM.
"""

# ── PROMPT PRINCIPAL ──────────────────────────────────────────────────────────
# Usado en: rag_service.py, rag_params_service.py, routers/rag_params.py
