...
import psutil
import requests
import websocket  # <- Nueva librería requerida
    ...
    try:
        ...
        while True:
            ...
            if tipo_msg == "respuesta":
                ...
                break  # Fin de la respuesta exitosa
            elif tipo_msg == "error":
                estado = "error_ws"
        ...
        return {
            ...
            "respuesta": respuesta_final, "latencia_ms": latencia_ms,
            "think_time_s": round(think_time, 1), "estado": estado,
